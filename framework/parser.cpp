...
static const char *const yytname[] =
{
  ...
  "TCEQ", "TCNE", "TCLT", "TCLE", "TCGT", "TCGE", "TEQUAL", "SEMI",
  "COMMA", "DOT", "LP", "RP", "LB", "RB", "LC", "RC", "STRUCT", "RETURN",
  "IF", "THEN", "ELSE", "BREAK", "CONT", "FOR", "TPLUS", "TMINUS", "TMUL",
  "TDIV", "TRETURN", "TEXTERN", "PLUS", "$accept", "program", "stmts",
  "stmt", YY_NULLPTR
};
#endif
